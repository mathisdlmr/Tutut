...
return [
    ...
    'calendar_manager' => [
        ...
        'legend_exam_period' => 'Période d\'examens',
        'legend_vacances' => 'Vacances',
        'legend_modified' => 'Jour modifié',
        'legend_medians_short' => 'Med.',
        'legend_finaux_short' => 'Fin.',
        'legend_vacances_short' => 'Vac.',
